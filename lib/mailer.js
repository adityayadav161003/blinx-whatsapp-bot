...
async function sendBookingConfirmationEmail({
  ...
  if (process.env.RESEND_API_KEY) {
    try {
      const fromEmail = process.env.RESEND_FROM_EMAIL || "Blinx Lab <onboarding@resend.dev>";
      ...
      console.error("[MAILER] Resend API error:", err.response ? err.response.data : err.message);
    }
  }
