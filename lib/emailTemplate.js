          ...
          <tr>
            <td style="padding: 28px 22px 32px 22px; background-color: #141414;">
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 24px;">
                <tr>
                  <td align="center">
                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=30-Minute+Strategy+Session+with+Blinx+Lab&details=Google+Meet+Link:+${encodeURIComponent(meetLink)}&location=Google+Meet" target="_blank" style="display: inline-block; font-size: 13px; color: #f5b041 !important; text-decoration: underline; font-weight: 600; padding: 6px 12px;">
