          ...
          <tr>
            <td style="padding: 28px 22px 32px 22px; background-color: #141414;">
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 24px;">
                <tr>
                  <td align="center" style="background-color: #1f1f1f; border: 1px solid #383838; border-radius: 10px;">
                    <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=30-Minute+Strategy+Session+with+Blinx+Lab&details=Google+Meet+Link:+${encodeURIComponent(meetLink)}&location=Google+Meet" target="_blank" style="display: block; width: 100%; padding: 13px 20px; font-size: 14px; font-weight: 700; color: #f5b041 !important; text-decoration: none; text-align: center; box-sizing: border-box; letter-spacing: 0.3px;">
          ...
          <tr>
            <td align="center" style="padding: 20px 20px; background-color: #0d0d0d; border-top: 1px solid #1e1e1e; text-align: center;">
              ...
              <p style="margin: 0; color: #555555; font-size: 11px;">
                Support: support@blinxlab.in | Mathura, India
              </p>
            </td>
          </tr>
